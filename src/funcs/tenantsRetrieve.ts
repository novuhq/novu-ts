...
export async function tenantsRetrieve(
    ...
    Result<
        components.GetTenantResponseDto,
        | SDKError
        | SDKValidationError
        | UnexpectedClientError
        | InvalidRequestError
...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => operations.TenantControllerGetTenantByIdRequest$outboundSchema.parse(value$),
    ...
    const [result$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(200, components.GetTenantResponseDto$inboundSchema),
