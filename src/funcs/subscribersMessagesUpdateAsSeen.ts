...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) =>
            operations.SubscribersControllerMarkActionAsSeenRequest$outboundSchema.parse(value$),
    ...
    const path$ = pathToFunc("/v1/subscribers/{subscriberId}/messages/{messageId}/actions/{type}")(
        pathParams$
    );
