...
export async function adminTestingControllerIdempotencyGet(
  ...
  >
> {
  const input: operations.TestingControllerIdempotencyGetRequest = {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.TestingControllerIdempotencyGetRequest$outboundSchema.parse(
        value,
      ),
  ...
  const context = {
    operationID: "TestingController_idempotencyGet",
    oAuth2Scopes: [],
