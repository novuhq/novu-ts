 ...
 */
export async function workflowsStatusUpdate(
    client$: NovuCore,
    workflowId: string,
...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) =>
            operations.WorkflowControllerUpdateActiveStatusRequest$outboundSchema.parse(value$),
    ...
    const body$ = encodeJSON$("body", payload$.ChangeWorkflowStatusRequestDto, { explode: true });
    ...
    const path$ = pathToFunc("/v1/workflows/{workflowId}/status")(pathParams$);
