...
> {
  const input: operations.AgentsControllerGetAgentRequest = {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.AgentsControllerGetAgentRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.AgentsControllerGetAgentResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
