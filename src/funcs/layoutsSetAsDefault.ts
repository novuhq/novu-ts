 ...
 */
export async function layoutsSetAsDefault(
  client: NovuCore,
  layoutId: string,
...
> {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.LayoutsControllerSetDefaultLayoutRequest$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/v1/layouts/{layoutId}/default")(pathParams);
