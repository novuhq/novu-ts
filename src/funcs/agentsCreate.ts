...
> {
  const input: operations.AgentsControllerCreateAgentRequest = {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.AgentsControllerCreateAgentRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.CreateAgentRequestDto, {
    explode: true,
  });
  ...
  const headers = new Headers(compactMap({
    ...
    "Novu-Analytics-Source": encodeSimple(
      "Novu-Analytics-Source",
      payload["Novu-Analytics-Source"],
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, operations.AgentsControllerCreateAgentResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
