...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) =>
            operations.SubscribersControllerChatOauthCallbackRequest$outboundSchema.parse(value$),
    ...
    const [result$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(200, operations.SubscribersControllerChatOauthCallbackResponseBody$inboundSchema),
