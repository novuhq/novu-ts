...
> {
    ...
    const path$ = pathToFunc("/v1/subscribers/{subscriberId}/preferences/{parameter}")(pathParams$);
    ...
    const [result$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(200, z.array(components.GetSubscriberPreferencesResponseDto$inboundSchema)),
