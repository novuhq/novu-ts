...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) =>
            operations.SubscribersControllerChatAccessOauthRequest$outboundSchema.parse(value$),
    ...
    const path$ = pathToFunc("/v1/subscribers/{subscriberId}/credentials/{providerId}/oauth")(
        pathParams$
    );
