...
export function agentsList(
  ...
  Result<
    operations.AgentsControllerListAgentsResponse,
    | errors.ErrorDto
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AgentsControllerListAgentsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.AgentsControllerListAgentsResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
