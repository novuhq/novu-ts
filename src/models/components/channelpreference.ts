...
/** @internal */
export const ChannelPreferenceType$inboundSchema: z.ZodNativeEnum<typeof ChannelPreferenceType> =
    z.nativeEnum(ChannelPreferenceType);

/** @internal */
export const ChannelPreferenceType$outboundSchema: z.ZodNativeEnum<typeof ChannelPreferenceType> =
...
/** @internal */
export const ChannelPreference$inboundSchema: z.ZodType<ChannelPreference, z.ZodTypeDef, unknown> =
    z.object({
        enabled: z.boolean(),
