...
/** @internal */
export const TextAlign$inboundSchema: z.ZodNativeEnum<typeof TextAlign> = z.nativeEnum(TextAlign);

/** @internal */
export const TextAlign$outboundSchema: z.ZodNativeEnum<typeof TextAlign> = TextAlign$inboundSchema;
...
/** @internal */
export const EmailBlockStyles$inboundSchema: z.ZodType<EmailBlockStyles, z.ZodTypeDef, unknown> =
    z.object({
