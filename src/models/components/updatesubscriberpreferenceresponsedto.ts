...
export namespace UpdateSubscriberPreferenceResponseDto$ {
    ...
    export const inboundSchema = UpdateSubscriberPreferenceResponseDto$inboundSchema;
    /** @deprecated use `UpdateSubscriberPreferenceResponseDto$outboundSchema` instead. */
    export const outboundSchema = UpdateSubscriberPreferenceResponseDto$outboundSchema;
