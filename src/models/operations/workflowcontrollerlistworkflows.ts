...
export namespace WorkflowControllerListWorkflowsRequest$ {
    ...
    export const inboundSchema = WorkflowControllerListWorkflowsRequest$inboundSchema;
    /** @deprecated use `WorkflowControllerListWorkflowsRequest$outboundSchema` instead. */
    export const outboundSchema = WorkflowControllerListWorkflowsRequest$outboundSchema;
