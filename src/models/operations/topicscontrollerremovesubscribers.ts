...
export namespace TopicsControllerRemoveSubscribersRequest$ {
    ...
    export const inboundSchema = TopicsControllerRemoveSubscribersRequest$inboundSchema;
    /** @deprecated use `TopicsControllerRemoveSubscribersRequest$outboundSchema` instead. */
    export const outboundSchema = TopicsControllerRemoveSubscribersRequest$outboundSchema;
