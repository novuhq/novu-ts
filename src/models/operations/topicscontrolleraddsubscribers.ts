...
export namespace TopicsControllerAddSubscribersRequest$ {
    ...
    export const inboundSchema = TopicsControllerAddSubscribersRequest$inboundSchema;
    /** @deprecated use `TopicsControllerAddSubscribersRequest$outboundSchema` instead. */
    export const outboundSchema = TopicsControllerAddSubscribersRequest$outboundSchema;
