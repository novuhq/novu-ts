...
/** @internal */
export const SubscribersControllerModifySubscriberChannelRequest$inboundSchema: z.ZodType<
...
/** @internal */
export const SubscribersControllerModifySubscriberChannelRequest$outboundSchema: z.ZodType<
...
export namespace SubscribersControllerModifySubscriberChannelRequest$ {
    ...
    export const inboundSchema = SubscribersControllerModifySubscriberChannelRequest$inboundSchema;
    ...
    export type Outbound = SubscribersControllerModifySubscriberChannelRequest$Outbound;
}
