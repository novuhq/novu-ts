...
/** @internal */
export const SubscribersControllerUpdateSubscriberOnlineFlagRequest$inboundSchema: z.ZodType<
...
/** @internal */
export const SubscribersControllerUpdateSubscriberOnlineFlagRequest$outboundSchema: z.ZodType<
...
export namespace SubscribersControllerUpdateSubscriberOnlineFlagRequest$ {
    ...
    export type Outbound = SubscribersControllerUpdateSubscriberOnlineFlagRequest$Outbound;
}
