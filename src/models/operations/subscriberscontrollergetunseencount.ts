...
/** @internal */
export const SubscribersControllerGetUnseenCountRequest$inboundSchema: z.ZodType<
...
/** @internal */
export const SubscribersControllerGetUnseenCountRequest$outboundSchema: z.ZodType<
...
export namespace SubscribersControllerGetUnseenCountRequest$ {
    ...
    export const inboundSchema = SubscribersControllerGetUnseenCountRequest$inboundSchema;
    /** @deprecated use `SubscribersControllerGetUnseenCountRequest$outboundSchema` instead. */
    export const outboundSchema = SubscribersControllerGetUnseenCountRequest$outboundSchema;
