...
/** @internal */
export const SubscribersControllerDeleteSubscriberCredentialsRequest$inboundSchema: z.ZodType<
...
/** @internal */
export const SubscribersControllerDeleteSubscriberCredentialsRequest$outboundSchema: z.ZodType<
...
export namespace SubscribersControllerDeleteSubscriberCredentialsRequest$ {
    ...
    export type Outbound = SubscribersControllerDeleteSubscriberCredentialsRequest$Outbound;
}
