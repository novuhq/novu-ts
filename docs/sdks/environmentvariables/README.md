...
<!-- UsageSnippet language="typescript" operationID="EnvironmentVariablesController_getEnvironmentVariable" method="get" path="/v1/environment-variables/{variableKey}" -->
```typescript
import { Novu } from "@novu/api";
...
async function run() {
  const result = await novu.environmentVariables.retrieve("BASE_URL");
...
async function run() {
  const res = await environmentVariablesRetrieve(novu, "BASE_URL");
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
...
<!-- UsageSnippet language="typescript" operationID="EnvironmentVariablesController_updateEnvironmentVariable" method="patch" path="/v1/environment-variables/{variableKey}" -->
```typescript
import { Novu } from "@novu/api";
...
async function run() {
  const result = await novu.environmentVariables.update({}, "BASE_URL");
...
async function run() {
  const res = await environmentVariablesUpdate(novu, {}, "BASE_URL");
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
...
<!-- UsageSnippet language="typescript" operationID="EnvironmentVariablesController_deleteEnvironmentVariable" method="delete" path="/v1/environment-variables/{variableKey}" -->
```typescript
import { Novu } from "@novu/api";
...
async function run() {
  const result = await novu.environmentVariables.delete("BASE_URL");
...
async function run() {
  const res = await environmentVariablesDelete(novu, "BASE_URL");
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
...
<!-- UsageSnippet language="typescript" operationID="EnvironmentVariablesController_getEnvironmentVariableUsage" method="get" path="/v1/environment-variables/{variableKey}/usage" -->
```typescript
import { Novu } from "@novu/api";
...
async function run() {
  const result = await novu.environmentVariables.usage("BASE_URL");
...
async function run() {
  const res = await environmentVariablesUsage(novu, "BASE_URL");
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
