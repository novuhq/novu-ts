...
* [eventsControllerTrigger](#eventscontrollertrigger) - Trigger event
* [eventsControllerTriggerBulk](#eventscontrollertriggerbulk) - Bulk trigger event
* [eventsControllerBroadcastEventToAll](#eventscontrollerbroadcasteventtoall) - Broadcast event to all
* [eventsControllerCancel](#eventscontrollercancel) - Cancel triggered event

## eventsControllerTrigger
...
async function run() {
  const result = await novu.events.eventsControllerTrigger({
    name: "<value>",
    payload: {},
    overrides: {},
    to: [
...
async function run() {
  const result = await novu.events.eventsControllerTriggerBulk({
    events: [
      {
        name: "<value>",
        payload: {},
...
## eventsControllerBroadcastEventToAll
...
async function run() {
  const result = await novu.events.eventsControllerBroadcastEventToAll({
    name: "<value>",
    payload: {},
    overrides: {},
  });
...
async function run() {
  const result = await novu.events.eventsControllerCancel("<value>");
