...
* [get](#get) - Get subscriber preferences
...
```typescript
import { NovuCore } from "@novu/api/core.js";
import { subscribersPreferencesGet } from "@novu/api/funcs/subscribersPreferencesGet.js";
...
async function run() {
  const res = await subscribersPreferencesGet(novu, "<id>");
...
```typescript
import { NovuCore } from "@novu/api/core.js";
import { subscribersPreferencesGetByLevel } from "@novu/api/funcs/subscribersPreferencesGetByLevel.js";
