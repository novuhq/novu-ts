...
import { feedsCreate } from "@novu/api/funcs/feedsCreate.js";
...
async function run() {
  const res = await feedsCreate(novu, {
    name: "<value>",
  });
...
**Promise\<[components.FeedResponseDto](../../models/components/feedresponsedto.md)\>**
...
```typescript
import { NovuCore } from "@novu/api/core.js";
import { feedsDelete } from "@novu/api/funcs/feedsDelete.js";
...
async function run() {
  const res = await feedsDelete(novu, "<value>");
...
**Promise\<[components.FeedResponseDto[]](../../models/.md)\>**
...
```typescript
import { NovuCore } from "@novu/api/core.js";
import { feedsRetrieve } from "@novu/api/funcs/feedsRetrieve.js";
...
async function run() {
  const res = await feedsRetrieve(novu);
