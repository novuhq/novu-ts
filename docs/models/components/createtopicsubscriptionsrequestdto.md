...
| `context`                                                                                                                                                                                                                                   | Record<string, *components.CreateTopicSubscriptionsRequestDtoContext*>                                                                                                                                                                      | :heavy_minus_sign:                                                                                                                                                                                                                          | N/A                                                                                                                                                                                                                                         |                                                                                                                                                                                                                                             |
| `preferences`                                                                                                                                                                                                                               | *components.Preferences*[]                                                                                                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                                                                                          | The preferences of the topic. Can be a simple workflow ID string, workflow preference object, or group filter object                                                                                                                        | [<br/>{<br/>"workflowId": "workflow-123",<br/>"condition": {<br/>"===": [<br/>{<br/>"var": "payload.tier"<br/>},<br/>"premium"<br/>]<br/>}<br/>}<br/>]                                                                                      |