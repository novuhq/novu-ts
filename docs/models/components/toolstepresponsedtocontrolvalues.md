...
```typescript
import { ToolStepResponseDtoControlValues } from "@novu/api/models/components";

let value: ToolStepResponseDtoControlValues = {
  skip: {
    "and": [
      {
        "==": [
...
| `body`                                                                                                                                                                                                       | *string*                                                                                                                                                                                                     | :heavy_minus_sign:                                                                                                                                                                                           | Content of the tool payload.                                                                                                                                                                                 |                                                                                                                                                                                                              |
