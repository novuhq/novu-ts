...
```typescript
import { ResourceDiffDtoTargetResource } from "@novu/api/models/components";

let value: ResourceDiffDtoTargetResource = {
...
| `updatedBy`                                                                                                            | [components.ResourceDiffDtoTargetResourceUpdatedBy](../../models/components/resourcediffdtotargetresourceupdatedby.md) | :heavy_minus_sign:                                                                                                     | User who last updated the resource                                                                                     |                                                                                                                        |
