...
| `providerId`                                                                                                                 | [components.GetChannelConnectionResponseDtoProviderId](../../models/components/getchannelconnectionresponsedtoproviderid.md) | :heavy_check_mark:                                                                                                           | The provider identifier (e.g., sendgrid, twilio, slack, etc.).                                                               | slack                                                                                                                        |
