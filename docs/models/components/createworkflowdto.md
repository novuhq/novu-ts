...
| `agent`                                                                                                          | [components.Agent](../../models/components/agent.md)                                                             | :heavy_minus_sign:                                                                                               | Optional agent assignment used to route this workflow through an agent's connected channels. Pass null to clear. |
