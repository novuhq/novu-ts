...
| `providerOverrides`                                                                                                                     | [components.ThrottleStepResponseDtoProviderOverrides](../../models/components/throttlestepresponsedtoprovideroverrides.md)              | :heavy_minus_sign:                                                                                                                      | Per-provider content overrides keyed by providerId. Stored separately from controlValues and merged over the default body at send time. |
