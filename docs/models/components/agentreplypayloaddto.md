...
| `typing`                                                                                                                                                                | *components.Typing*                                                                                                                                                     | :heavy_minus_sign:                                                                                                                                                      | Per-turn typing/status control. Pass `{ status?: string }` to set/update the status (omit `status` for "Thinking…"), or `"stop"` to clear it. Best-effort per platform. | **Example 1:** {<br/>"status": "Looking up your order…"<br/>}<br/>**Example 2:** stop                                                                                   |
