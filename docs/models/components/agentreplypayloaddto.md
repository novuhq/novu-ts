...
| `signals`                                                                                                                                                               | *components.Signals*[]                                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                      | Side-effect signals executed during this turn: conversation metadata mutations, Novu workflow triggers, or human-in-the-loop interactions.                              |                                                                                                                                                                         |
