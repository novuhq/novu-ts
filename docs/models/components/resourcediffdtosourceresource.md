...
```typescript
import { ResourceDiffDtoSourceResource } from "@novu/api/models/components";

let value: ResourceDiffDtoSourceResource = {
...
| `updatedBy`                                                                                   | [components.ResourceDiffDtoUpdatedBy](../../models/components/resourcediffdtoupdatedby.md)    | :heavy_minus_sign:                                                                            | User who last updated the resource                                                            |                                                                                               |
