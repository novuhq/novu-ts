...
| `agent`                                                                                                            | [components.WorkflowResponseDtoAgent](../../models/components/workflowresponsedtoagent.md)                         | :heavy_minus_sign:                                                                                                 | Optional agent assignment used to route this workflow through an agent's connected channels. Null when unassigned. |
