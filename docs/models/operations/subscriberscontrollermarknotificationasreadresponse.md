...
```typescript
import { SubscribersControllerMarkNotificationAsReadResponse } from "@novu/api/models/operations";

let value: SubscribersControllerMarkNotificationAsReadResponse = {
  headers: {
    "key": [],
    "key1": [],
  },
