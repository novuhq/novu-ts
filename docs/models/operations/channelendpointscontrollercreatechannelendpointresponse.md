...
```typescript
import { ChannelEndpointsControllerCreateChannelEndpointResponse } from "@novu/api/models/operations";

let value: ChannelEndpointsControllerCreateChannelEndpointResponse = {
  headers: {
    "key": [
      "<value 1>",
      "<value 2>",
