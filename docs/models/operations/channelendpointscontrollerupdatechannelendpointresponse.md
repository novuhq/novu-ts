...
```typescript
import { ChannelEndpointsControllerUpdateChannelEndpointResponse } from "@novu/api/models/operations";

let value: ChannelEndpointsControllerUpdateChannelEndpointResponse = {
  headers: {
    "key": [
      "<value 1>",
      "<value 2>",
