...
```typescript
import { ChannelConnectionsControllerUpdateChannelConnectionResponse } from "@novu/api/models/operations";

let value: ChannelConnectionsControllerUpdateChannelConnectionResponse = {
  headers: {
    "key": [
      "<value 1>",
      "<value 2>",
